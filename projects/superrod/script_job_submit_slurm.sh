...
#SBATCH --job-name=test_0218-1620
#SBATCH --output=test_0218-1620.log
#SBATCH --time=0:30:60
...
#python $HOME/DaFy/projects/superrod/ray_cluster_test.py 10& 
python -u $HOME/DaFy/projects/superrod/run_models_on_cluster.py $redis_password 40 # Pass the total number of allocated CPUs
