...
sys.path.append(os.path.join(DaFy_path,'scripts','chemlab'))
from chemlab.graphics.qt.qchemlabwidget import QChemlabWidget
    ...
    **Example**
    ...
    def add_renderer(self, klass, *args, **kwargs):
        ...
        **Return**
        ...
        '''
        renderer = klass(super(), *args, **kwargs)
