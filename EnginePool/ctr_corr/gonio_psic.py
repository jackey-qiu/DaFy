...
def tand(value):
    return num.tan(num.deg2rad(value))
...
def arccosd(value):
    return num.rad2deg(num.arccos(value))

def arcsind(value):
    return num.rad2deg(num.arcsin(value))

def arctand(value):
    return num.rad2deg(num.tan(value))

import numpy.linalg as la
def cartesian_mag(vec):
