import reciprocal_space_old as rsp
...
Co3O4_lat = rsp.lattice.lattice_from_cif('/home/finn/Documents/eclipse_workspace/2017_MA3074/preparation/structure_simulation/Co3O4.cif', HKL_normal = [1,1,1])
...
if(0):      
    ...
    Bi_space.plot_peaks(qz_lims=[-1e-5,5], color=(1,0,0))
