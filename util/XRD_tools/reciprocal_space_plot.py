import reciprocal_space as rsp
...
Co3O4_lat = rsp.lattice.lattice_from_cif('/home/finn/Documents/eclipse_workspace/2017_MA3074/preparation/structure_simulation/Co3O4.cif', HKL_normal = [1,1,1], HKL_para_x=[1,1,-2])
...
Bi_lat = rsp.lattice(a   = 6.674, 
              b          = 6.117, 
              c          = 3.304,
              alpha      = 90,     
              beta       = 110.33,     
              gamma      = 90,     
              basis      = [[1, 0, 0, 0], [1, 0.5, 0.5, 0]], 
              HKL_normal = [1,1,0],
              HKL_para_x = [1,0,0]
              )


Bi_lat2 = rsp.lattice(a   = 4.75, 
              b          = 4.75, 
              c          = 4.75,
              alpha      = 57.35,     
              beta       = 57.35,     
...
if(0):      
    ...
    Bi_space.plot_peaks(HKL_lims=[-10, 10], qz_lims=[-1e-5,5], color=(1,0,0))
    ...
    #Bi_space2.plot_peaks(qz_lims=[-1e-5,5], color=(1,0,0))
    Bi_space3 = space_plot(Bi_lat3)
    #Bi_space3.plot_peaks(qz_lims=[-1e-5,5], color=(1,0,0))    
    Bi_space4 = space_plot(Bi_lat4)
    #Bi_space4.plot_peaks(qz_lims=[-1e-5,5], color=(1,0,0))    
