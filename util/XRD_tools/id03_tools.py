...
import edf_image_v3 as edf_img
import numpy as np
...
class DetectorImg(): 
    ...
    def set_params(self, E_keV=0.0, cen=(0,0), pixelsize=(0,0), sdd=0.0, spec_filename="", edf_path=""):
        ...
        self.img_loader = edf_img.edf_image_loader(spec_filename, edf_path)
    ...
    def _prepare_frame(self, scan_no, frame_no, norm_mon=True, norm_transm=True, gz_compressed=False):
        ...
        if('zapline mottime' in img.header['#S']):
    ...
    def get_q(self, scan_no, frame_no, norm_mon=True, norm_transm=True, gz_compressed=True):
...
if __name__ == '__main__':
    spec_filename = '/home/qiu/data/MA3886_partial/ma3886_sixcvertical.spec'
    edf_path = '/home/qiu/data/MA3886_partial/ma3886_img'
