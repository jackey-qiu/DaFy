...
class lattice():
    def __init__(self, a, b, c, alpha=90, beta=90, gamma=90, basis=[0,0,0], HKL_normal=[0,0,1], HKL_para_x=[1,0,0], offset_angle=0, energy_keV=22.5):
        self.a = a
        self.b = b
        self.c = c
        ...
        self.RealTM = np.array([[self.A1[0], self.A2[0], self.A3[0]], [self.A1[1], self.A2[1], self.A3[1]], [self.A1[2], self.A2[2], self.A3[2]]])
        ...
        if(0):
            ...
            for line in lines:
                ...
                mlab.plot3d([xyz1[0], xyz2[0]], [xyz1[1], xyz2[1]], [xyz1[2], xyz2[2]])
    ...
    @staticmethod 
    def lattice_from_cif(filename, HKL_normal=[0,0,1], HKL_para_x=[1,0,0], offset_angle=0, energy_keV=22.5):
        ...
        for atom_site in atom_sites:
            f1, f2 = elements.symbol(atom_site[0]).xray.scattering_factors(energy=energy_keV)
        ...
        return lattice(a, b, c, alpha, beta, gamma, basis, HKL_normal, HKL_para_x, offset_angle, energy_keV=energy_keV)
