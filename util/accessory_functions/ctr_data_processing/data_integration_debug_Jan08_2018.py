...
BRAGG_PEAK_CUTOFF=0.03#excluding range on L close to a Bragg peak (L_Bragg+-this value will be excluded for plotting)
...
class data_integration:
    def __init__(self,spec_path='M:\\fwog\\members\\qiu05\\Dec_2017_APS\\fer',spec_name='rcut_cmp_zn_7mm_1.spec',scan_number=[15]+range(17,41),\
