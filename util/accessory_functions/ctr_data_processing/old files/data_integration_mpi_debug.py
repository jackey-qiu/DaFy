...
scan_number=range(75,101)#+range(44,70)#+range(75,101)
...
INTEG_PARS['center_pix']=[96,156]#[53,153] or [91,247] fro ESRF#Center pixel index (know Python is column basis, so you need to swab the order of what you see at pixe image)
...
class data_integration_mpi:
    ...
    def assign_jobs(self):
        ...
        start_index,end_index=find_boundary(self.size,len(images),self.rank)
    ...
    def sort_spec_file(self,spec_path='.',spec_name='mica-zr_s2_longt_1.spec',scan_number=[16,17,19],\
        ...
        if scan_number==None:#if None, then take all rodscan and Escan existing in the spec file
            ...
            for i in range(len(scan_rows)):
                ...
                if scan_type_temp=='rodscan' or scan_type_temp=='Escan':#only extract rodscan and Escan
                    j=0
